...
var fight = function(enemyName){
    ...
    while(playerHealth > 0 && enemyHealth > 0){
        ...
        // Prompt players if they wish to fight
...
var startGame = function() {
    ...
    // after the loop ends, player is either out of health or enemies to fight, so runt the endGame function
    endGame();
  };
  ...
  var shop = function(){
    ...
    switch (shopOptionPrompt){
        ...
        case "LEAVE":
        case "leave":
            window.alert("Leavingn the store.");
